...
#include "ObstaculoBolaActor.h"


// Sets default values
AObstaculoBolaActor::AObstaculoBolaActor()
{
...
void AObstaculoBolaActor::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AObstaculoBolaActor::Tick( float DeltaTime )
{
	...
	LocalizacaoAtual.Y += DeltaRange * 400.0f;
